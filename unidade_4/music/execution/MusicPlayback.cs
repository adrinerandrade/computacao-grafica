...
namespace gcgcg
{
  ...
  {
    private static MusicPlayback Instance;

    public int Dalay { get; set; }

    public MusicPlayback getInstance() {
      if (MusicPlayback.Instance == null) {
        MusicPlayback.Instance = new MusicPlayback();
      }
